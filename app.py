...
app.config['MYSQL_HOST'] = '34.105.238.155'
mysql.init_app(app)
...
def read(cursor):
    ...
    html = f"<table style='border: 1px solid red'><tr style='border: 1px solid red'><th  style='border: 1px solid red'>Name</th><th style='border: 1px solid red'>Email</th></tr>{html}</table>"
